...
import cztongcheng.dev.liuxiaocong.cztongcheng.Home.News.ENewsTypeConverter;
...
public class TitleModelDao extends AbstractDao<TitleModel, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property NewsType = new Property(5, Integer.class, "newsType", false, "NEWS_TYPE");
    };

    private final ENewsTypeConverter newsTypeConverter = new ENewsTypeConverter();
    ...
    protected final void bindValues(DatabaseStatement stmt, TitleModel entity) {
        ...
        ENewsType newsType = entity.getNewsType();
        if (newsType != null) {
            stmt.bindLong(6, newsTypeConverter.convertToDatabaseValue(newsType));
        }
    }
    ...
    public TitleModel readEntity(Cursor cursor, int offset) {
        TitleModel entity = new TitleModel( //
            ...
            cursor.isNull(offset + 5) ? null : newsTypeConverter.convertToEntityProperty(cursor.getInt(offset + 5)) // newsType
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TitleModel entity, int offset) {
        ...
        entity.setNewsType(cursor.isNull(offset + 5) ? null : newsTypeConverter.convertToEntityProperty(cursor.getInt(offset + 5)));
     }
